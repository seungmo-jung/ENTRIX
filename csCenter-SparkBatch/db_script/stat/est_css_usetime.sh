...
function getSQL() {
	...
	local SQL="INSERT INTO est_css_usetime_$targetname(stat_$targetname, app_id, so_id, css_ip, 
...
c_10_30m, s_10_30m, c_30_60m, s_30_60m, c_other, s_other, total_cnt, chg_date) SELECT '$statdate' AS stat_$targetname, app_id, so_id, css_ip,  
...
SUM(total_cnt), '$nowdate' FROM est_css_usetime_$srcname WHERE stat_$srcname LIKE '$statdate%' GROUP BY app_id, so_id, css_ip;"
...
daySQL="INSERT INTO est_css_usetime_day(stat_day, app_id, so_id, css_ip, 
c_1_10s, s_1_10s, c_11_20s, s_11_20s, c_21_30s, s_21_30s, c_31_40s, s_31_40s, c_41_50s, s_41_50s, c_51_60s, s_51_60s, 
c_1_2m, s_1_2m, c_2_3m, s_2_3m, c_3_4m, s_3_4m, c_4_5m, s_4_5m, c_5_6m, s_5_6m, c_6_7m, s_6_7m, c_7_8m, s_7_8m, c_8_9m, s_8_9m, c_9_10m, s_9_10m, 
c_10_30m, s_10_30m, c_30_60m, s_30_60m, c_other, s_other, total_cnt, chg_date) SELECT '$statday', app_id, so_id, css_ip, 
SUM(c_1_10s), IFNULL((SUM(c_1_10s) / SUM(total_cnt) * 100), '0'),
SUM(c_11_20s), IFNULL((SUM(c_11_20s) / SUM(total_cnt) * 100), '0'),
SUM(c_21_30s), IFNULL((SUM(c_21_30s) / SUM(total_cnt) * 100), '0'),
SUM(c_31_40s), IFNULL((SUM(c_31_40s) / SUM(total_cnt) * 100), '0'),
...
SUM(c_30_60m), IFNULL((SUM(c_30_60m) / SUM(total_cnt) * 100), '0'),
SUM(c_other), IFNULL((SUM(c_other) / SUM(total_cnt) * 100), '0'),
SUM(total_cnt), '$nowdate' FROM est_css_usetime_hour WHERE stat_hour LIKE '$statday%' GROUP BY app_id, so_id, css_ip;"
