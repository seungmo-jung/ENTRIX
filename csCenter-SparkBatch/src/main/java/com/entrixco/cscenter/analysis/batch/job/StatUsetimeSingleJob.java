...
public class StatUsetimeSingleJob extends BatchJob {
	
	private static final Logger logger = LoggerFactory.getLogger(StatUsetimeSingleJob.class);
	...
	public void execute(JobExecutionContext jobctx) {
		...
		long cssT = executeCssSingle(cmap
	...
	public static long executeCssSingle(Map<String, Object> cmap
		...
		DataFrame cssdf = hiveExec.executeSQL("stat@selectUsetimeCssSingle"
