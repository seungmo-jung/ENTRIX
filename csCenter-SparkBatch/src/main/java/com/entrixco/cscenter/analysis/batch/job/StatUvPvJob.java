...
public class StatUvPvJob extends BatchJob {
	
	private static final Logger logger = LoggerFactory.getLogger(StatUvPvJob.class);
	private static final String JOBNAME = "stat_uvpv";
	...
	public void execute(JobExecutionContext jobctx) {
		...
		if(cmap.containsKey("window")){
			...
			updateCssinfoTmp(cmap, winMin, beginStatMin, "CSS", "uvpv");
		}else{
			cssinfo_table="cssinfo_stat_uvpv";
		...
		long cssT = executeCss(cmap
				, curenddate, curbegindate, curenddt, curbegindt, curendhh, curbeginhh, cssinfo_table);
	...
	public static long executeCss(Map<String, Object> cmap
		...
		DataFrame cssdf = hiveExec.executeSQL("stat@selectUvPvCssM"
	...
	public static long executeSo(Map<String, Object> cmap
			...
			, String curendhh, String curbeginhh, String cssinfo_table) {
		HiveExecutor hiveExec = (HiveExecutor)cmap.get("hiveExec");
		DataFrame appdf = hiveExec.executeSQL("stat@selectUvPvAppM"
				, curbegindt, curbeginhh, curenddt, curendhh, curbegindate, curenddate
				, curbegindt, curbeginhh, curenddt, curendhh, curbegindate, curenddate
				, cssinfo_table
				);
	...
	public static long executeApp(Map<String, Object> cmap
			...
			, String curendhh, String curbeginhh, String cssinfo_table) {
		HiveExecutor hiveExec = (HiveExecutor)cmap.get("hiveExec");
		DataFrame sodf = hiveExec.executeSQL("stat@selectUvPvSoM"
				, curbegindt, curbeginhh, curenddt, curendhh, curbegindate, curenddate
				, curbegindt, curbeginhh, curenddt, curendhh, curbegindate, curenddate
				, cssinfo_table
				);
