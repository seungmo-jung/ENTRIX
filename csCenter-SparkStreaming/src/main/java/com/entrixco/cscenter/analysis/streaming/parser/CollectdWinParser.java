...
public class CollectdWinParser extends StreamParser {
	
	private static final Logger logger = LoggerFactory.getLogger(CollectdWinParser.class);
	
	public static void parse(final HashMap<String, Object> configMap,JavaStreamingContext jstCtx) {
		
		String topics = (String)configMap.get("colwinTopic");
